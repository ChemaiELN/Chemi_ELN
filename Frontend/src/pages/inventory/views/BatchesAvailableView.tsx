  ...
  const columns: ColumnsType<Batch> = [
    {
      ...
      onHeaderCell: () => ({ className: styles.stickyLeft }),
      onCell: () => ({ className: styles.stickyLeft }),
    ...
    },
    {
      ...
      onHeaderCell: () => ({ className: styles.stickyRightStatus }),
      onCell: () => ({ className: styles.stickyRightStatus }),
    ...
    },
    {
      ...
      onHeaderCell: () => ({ className: styles.stickyRightActions }),
      onCell: () => ({ className: styles.stickyRightActions }),
      render: (_, row) => (
        <Space size={4}>
    ...
    <div>
      <div className={styles.masterCard}>
        <div className={styles.masterCardHeader}>
          ...
          <InventoryAddButton onClick={openReceive}>New Batch Receipt</InventoryAddButton>
        </div>
        <Table<Batch>
          rowKey="id" size="small" loading={loading}
          dataSource={rows} columns={columns}
          className={`${styles.masterTable} ${styles.batchesStickyTable}`}
      ...
      <Modal
        title="New Batch Receipt" open={recvOpen}
