...
import {
  Table, Button, Input, Switch, Modal, Form, InputNumber, DatePicker,
  ...
  const columns: ColumnsType<ColumnCatalogue> = [
    ...
    },
    {
      ...
      render: (_, r) => {
        ...
        const strokeColor = pct != null && pct >= 90 ? '#e11d48' : pct != null && pct >= 70 ? '#d97706' : '#4a9290'
        return (
          <div>
    ...
    <div>
      ...
      <div className={styles.masterCard}>
        <div className={styles.masterCardHeader}>
          ...
          <InventoryAddButton onClick={openAdd}>Add Column</InventoryAddButton>
        </div>
