      ...
      <div className={styles.dashWrap}>
        ...
        <div className={styles.dashHeader}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            {lastRefreshed && (
              <span className={styles.refreshMeta}>Updated at {dayjs(lastRefreshed).format('HH:mm')}</span>
            )}
            <Button
              size="small"
        ...
        <div className={styles.bottomRow}>
          ...
          <div className={styles.tableCard} style={{ flex: '0 0 35%' }}>
            <div className={styles.tableCardHeader}>
              ...
              <InventoryCountBadge count={actions.length} label="items" />
            </div>
            {actions.length === 0 ? (
          ...
          <div className={styles.tableCard} style={{ flex: 1 }}>
            <div className={styles.tableCardHeader}>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                ...
                />
                <InventoryCountBadge count={expiring.length} label="batches" />
              </div>
            </div>
            {expiring.length === 0 ? (
