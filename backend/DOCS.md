...
```
DATABASE_URL=postgresql://postgres:Admin%40123@localhost:5432/chemia_eln
SECRET_KEY=chemia-eln-dev-key-abcdef1234567890abcdef12
ALGORITHM=HS256
...
|---|---|---|
| `sys.admin` | QA (System Admin) | `Admin@123` |
| `tl.user` | TL (Team Lead) | `Admin@123` |
| `hod.user` | HOD (Head of Department) | `Admin@123` |
| `chem.user` | CHEM (Chemist) | `Admin@123` |
