...
# Phase A1:
from app.models import admin, settings as settings_models  # noqa: F401
# Phase A3:
from app.models import master_data as master_data_models  # noqa: F401
from app.models import master_data_admin as master_data_admin_models  # noqa: F401
# Phase B1:
