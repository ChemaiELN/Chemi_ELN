...
function MoleculeIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" aria-hidden="true">
      <circle cx="18" cy="18" r="18" fill="#0c5a54" opacity="0.12" />
      <circle cx="18" cy="18" r="5" fill="#0c5a54" />
      <circle cx="9"  cy="10" r="3" fill="#0c5a54" opacity="0.85" />
      <circle cx="27" cy="10" r="3" fill="#0c5a54" opacity="0.85" />
      <circle cx="9"  cy="26" r="3" fill="#0c5a54" opacity="0.85" />
      <circle cx="27" cy="26" r="3" fill="#0c5a54" opacity="0.85" />
      <line x1="18" y1="18" x2="9"  y2="10" stroke="#0c5a54" strokeWidth="1.5" opacity="0.6" />
      <line x1="18" y1="18" x2="27" y2="10" stroke="#0c5a54" strokeWidth="1.5" opacity="0.6" />
      <line x1="18" y1="18" x2="9"  y2="26" stroke="#0c5a54" strokeWidth="1.5" opacity="0.6" />
      <line x1="18" y1="18" x2="27" y2="26" stroke="#0c5a54" strokeWidth="1.5" opacity="0.6" />
    </svg>
  )
}
