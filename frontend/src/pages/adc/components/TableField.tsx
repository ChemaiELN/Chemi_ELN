...
function RichTextCell({
  ...
  return (
    ...
    >
      <div className="cursor-pointer min-h-[26px] text-xs text-slate-600 hover:bg-indigo-50/60 rounded px-1.5 py-1 transition-colors leading-relaxed line-clamp-2">
        {preview
          ? <span>{preview}</span>
...
function CellEditor({
  ...
  if (col.type === 'sds_from_mapping') {
    ...
    if (!matId) return <span className="text-slate-300 text-xs">—</span>
