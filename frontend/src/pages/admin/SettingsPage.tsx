...
function SectionCard({ icon, title, children }: { icon: React.ReactNode; title: string; children: React.ReactNode }) {
  return (
    <Card
      ...
      className="glass-card rounded-lg border-0 shadow-none mb-4"
...
const colLayout = { xs: 24, sm: 12, lg: 8 }
...
export default function SettingsPage() {
  ...
  if (isLoading) return <div className="p-6"><Skeleton active paragraph={{ rows: 12 }} /></div>
