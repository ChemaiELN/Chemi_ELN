...
import { Table, Button, Select, Input, Tag, Badge, message } from 'antd'
import { HomeOutlined, ExportOutlined, SearchOutlined, PlusOutlined } from '@ant-design/icons'
...
const MyATRsPage: React.FC = () => {
  ...
  const columns: ColumnsType<MyATRRecord> = [
    ...
    { title: 'Objectives', dataIndex: 'objectives', key: 'objectives' },
    {
      ...
      render: (v: string) => (
        <Tag className={`${styles.statusTag} ${statusClassMap[v] ?? styles.tagNew}`}>{v}</Tag>
      ),
    },
            ...
            <div className={styles.tableCardHeader}>
              ...
              <div className={styles.tableCardActions}>
                ...
                <Button className={styles.newAtrBtn} size="small" icon={<PlusOutlined />}
                  onClick={() => navigate('/atr/new')}>New ATR</Button>
              </div>
            </div>
            <Table<MyATRRecord>
