...
import { ArrowLeft, Plus, Pencil, Trash2, Send, CheckCircle2, RotateCcw, Copy } from 'lucide-react'
    ...
    <div className="p-4 md:p-6 space-y-4">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {cl.status === 'PENDING_VERIFICATION' && <Button type="primary" icon={<CheckCircle2 size={14} />} onClick={() => setWf('verify')}>Verify</Button>}
          {cl.status === 'PENDING_APPROVAL' && <Button type="primary" icon={<CheckCircle2 size={14} />} onClick={() => setWf('approve')}>Approve</Button>}
