...
import {
  Table, Button, Input, Tag, Switch, Modal, Form, DatePicker, Badge,
...
const SERVICE_COLOR: Record<string, string> = { OK: 'green', DUE: 'orange', OVERDUE: 'red', EXPIRED: 'red' }
        ...
        {detailRow && (
          <>
            ...
            <div className={styles.drawerSection}>
              <h4>Calibration</h4>
              <dl className={styles.kv}>
                <dt>Status</dt>      <dd><Tag color={SERVICE_COLOR[detailRow.calibration_status]} className={styles.statusTag}>{detailRow.calibration_status}</Tag></dd>
