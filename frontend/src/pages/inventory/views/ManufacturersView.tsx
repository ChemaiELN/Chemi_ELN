...
export default function ManufacturersView() {
  ...
  const handleClear = () => { setSearch(''); setActiveFilter(undefined) }
  ...
  const columns: ColumnsType<Manufacturer> = [
    ...
    { title: 'Email',   dataIndex: 'email',          key: 'email',          width: 190,
      render: v => v ? <a href={`mailto:${v}`} style={{ color: '#0d9488' }}>{v}</a> : <span className={styles.dimCell}>—</span> },
    ...
    <div>
      <div className={styles.masterCard}>
        <div className={styles.masterCardHeader}>
          ...
          <Button icon={<PlusOutlined />} size="small" className={styles.newBtn} onClick={openAdd}>Add Manufacturer</Button>
        </div>
        <Table<Manufacturer>
