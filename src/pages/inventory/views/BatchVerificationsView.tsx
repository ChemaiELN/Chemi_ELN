...
import {
  Table, Button, Input, Tag, Modal, Form, message, Badge,
  Select, Space, Tooltip, Popconfirm,
} from 'antd'
import type { ColumnsType } from 'antd/es/table'
import {
  PlusOutlined, CheckCircleOutlined, CloseCircleOutlined, SearchOutlined,
...
export default function BatchVerificationsView() {
  ...
  const handleClear = () => { setSearch(''); setStatusFilter(undefined); setBatchFilter(undefined) }
