...
import {
  Table, Button, Input, Switch, Tag, Modal, Form, Badge,
...
export default function MaterialsView() {
  ...
  const columns: ColumnsType<Material> = [
    ...
    },
    {
      ...
      render: v => v ? <Tag color="orange" className={styles.statusTag}>{v}</Tag> : <span className={styles.dimCell}>—</span>,
    },
    {
          ...
          <>
            <div className={styles.drawerSection}>
              ...
              <dl className={styles.kv}>
                ...
                <dt>Type</dt>          <dd><Tag color="blue" className={styles.statusTag}>{detailRow.material_type}</Tag></dd>
                ...
                <dt>Status</dt>        <dd><Tag color={detailRow.is_active ? 'success' : 'default'} className={styles.statusTag}>{detailRow.is_active ? 'Active' : 'Inactive'}</Tag></dd>
              </dl>
            </div>
