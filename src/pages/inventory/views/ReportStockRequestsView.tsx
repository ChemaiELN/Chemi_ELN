...
import {
  Table, Button, Input, Tag, Select, DatePicker, message, Badge,
} from 'antd'
...
const STATUS_COLOR: Record<string, string> = {
  ...
  FULFILLED: 'cyan', CANCELLED: 'default',
}

const CRIT_COLOR: Record<string, string> = {
  LOW: 'blue', MEDIUM: 'gold', HIGH: 'orange', CRITICAL: 'red',
}
...
const columns: ColumnsType<StockRequestReportRow> = [
  ...
  },
  {
    ...
    render: v => <Tag color={CRIT_COLOR[v] ?? 'default'} className={styles.statusTag}>{v}</Tag>,
  },
  {
