...
import {
  Table, Button, Input, Tag, Modal, Form, InputNumber,
  message, Select, Space, Tooltip, Popconfirm, DatePicker, Drawer, Badge,
} from 'antd'
...
export default function StockRequestsView() {
  ...
  const handleClear = () => {
    ...
    setCritFilter(undefined)
    setMatFilter(undefined)
  }
  ...
  const columns: ColumnsType<StockRequest> = [
    ...
    },
    {
      ...
      render: v => <Tag color={CRITICALITY_COLOR[v] ?? 'default'} className={styles.statusTag}>{v}</Tag>,
    },
    {
    ...
    <div>
      ...
      <div className={styles.masterCard}>
        <div className={styles.masterCardHeader}>
          ...
          <Button icon={<PlusOutlined />} size="small" className={styles.newBtn} onClick={openCreate}>New Request</Button>
        </div>
      ...
      >
        {remarksTarget && (
          <div className={styles.modalInfoBannerNeutral}>
            ...
            <Tag color={CRITICALITY_COLOR[remarksTarget.criticality]} className={styles.statusTag} style={{ marginLeft: 8 }}>
              {remarksTarget.criticality}
            </Tag>
          </div>
        )}
          ...
          <>
            <div className={styles.drawerSection}>
              ...
              <dl className={styles.kv}>
                ...
                <dt>Criticality</dt>   <dd><Tag color={CRITICALITY_COLOR[detailRow.criticality]} className={styles.statusTag}>{detailRow.criticality}</Tag></dd>
