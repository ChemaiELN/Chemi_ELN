 ...
 *   2. ATRs                 (searchATRs)
 *   3. Notebooks            (searchNotebooks)
 *   4. Projects             (searchProjects)
 */
import React, { useState } from 'react'
import {
  Tabs, Form, Input, Button, Select, DatePicker,
  Table, Tag, message, Space,
} from 'antd'
        ...
        <Form.Item>
          <Space size={4}>
            <Button size="small" type="primary" icon={<SearchOutlined />} onClick={handleSearch}
              style={{ background: '#5aa3a1', borderColor: '#5aa3a1' }}>Search</Button>
          ...
          <div className={styles.topBar}>
            <div>
              ...
              <h1 className={styles.pageTitle}>
                <SearchOutlined style={{ marginRight: 6, color: '#5aa3a1' }} />
                Search
              </h1>
            </div>
          </div>
