...
import PreliminaryExperimentPage  from '@/pages/experiments/preliminary'
...
import AdminWorkflowTemplatesPage        from '@/pages/admin/workflow-templates'
import AdminWorkflowTemplateConfigurePage from '@/pages/admin/workflow-templates/configure'
...
const router = createBrowserRouter([
  ...
  { path: '/reset-password',          element: <ResetPasswordPage /> },
  {
    ...
    children: [
      ...
      { path: '/experiments/:id/preliminary', element: <PreliminaryExperimentPage /> },
      ...
      { path: '/admin/workflow-templates',             element: <AdminWorkflowTemplatesPage /> },
      { path: '/admin/workflow-templates/new',         element: <AdminWorkflowTemplateConfigurePage /> },
      { path: '/admin/workflow-templates/:id',         element: <AdminWorkflowTemplateConfigurePage /> },
